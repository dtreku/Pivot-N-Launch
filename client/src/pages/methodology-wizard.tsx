...
export default function MethodologyWizard() {
  ...
  const handleComplete = () => {
    ...
    // Generate and download the personalized methodology toolkit
    const currentDate = new Date().toLocaleDateString();
    const personalizedToolkit = `
# Your Personalized Pivot-and-Launch Methodology
**Created on:** ${currentDate}
**Discipline:** ${formData.discipline || 'Not specified'}

## Your Configuration Summary

### Selected Discipline
${formData.discipline || 'Not specified'}

### Pivot Concepts
${formData.pivotConcepts || 'Not specified yet'}

### Assessment Boundaries
${formData.assessmentBoundaries || 'Not specified yet'}

### Launch Applications
${formData.launchApplications || 'Not specified yet'}

### Collaboration Methods
${formData.collaborationMethods || 'Not specified yet'}

### Core Knowledge Assessment
${formData.coreAssessment || 'Not specified yet'}

### Application Assessment
${formData.applicationAssessment || 'Not specified yet'}

### Anti-Overload Measures
${formData.antiOverloadMeasures || 'Not specified yet'}

### Implementation Timeline
${formData.timeline || 'Not specified yet'}

### Class Size
${formData.classSize || 'Not specified yet'}

### Required Resources
${formData.resources || 'Not specified yet'}

### Success Metrics
${formData.successMetrics || 'Not specified yet'}

### Methodology Steps Completed
✅ Discipline Selection
✅ Pivot Concepts Development
✅ Launch Applications Design
✅ Assessment Methods Planning
✅ Implementation Plan Creation

### Your PBL Framework
This methodology configuration provides the foundation for implementing your project-based learning approach.

### Next Steps
1. **Return to Your Dashboard** - Access additional platform tools
2. **Upload Course Materials** - Add syllabi, assignments, and resources
3. **Invite Students** - Use the collaboration portal for feedback
4. **Convert Learning Objectives** - Transform traditional goals into PBL format
5. **Monitor Progress** - Use analytics to track engagement

### Platform Features Available
- Methodology Wizard (Completed ✅)
...
- Export Toolkit: Available in header for complete guide
- Help Documentation: Available in Document Manager

---
*Generated by WPI Pivot-and-Launch PBL Platform*
*This personalized toolkit contains your methodology configuration for future reference*
`;

    // Download the personalized toolkit
    const blob = new Blob([personalizedToolkit], { type: 'text/plain' });
    const url = window.URL.createObjectURL(blob);
    const link = document.createElement('a');
    link.href = url;
    link.download = `My-PBL-Methodology-${currentDate.replace(/\//g, '-')}.txt`;
    ...
    alert('Congratulations! Your Pivot-and-Launch methodology has been successfully configured. Your personalized toolkit has been downloaded to your computer.');
          ...
          <div className="space-y-6">
            <div>
              ...
              <Textarea
                ...
                value={formData.pivotConcepts}
                onChange={(e) => setFormData({ ...formData, pivotConcepts: e.target.value })}
                data-testid="textarea-pivot-concepts"
              />
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                value={formData.assessmentBoundaries}
                onChange={(e) => setFormData({ ...formData, assessmentBoundaries: e.target.value })}
                data-testid="textarea-assessment-boundaries"
              />
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <Textarea
                ...
                value={formData.launchApplications}
                onChange={(e) => setFormData({ ...formData, launchApplications: e.target.value })}
                data-testid="textarea-launch-applications"
              />
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                value={formData.collaborationMethods}
                onChange={(e) => setFormData({ ...formData, collaborationMethods: e.target.value })}
                data-testid="textarea-collaboration-methods"
              />
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <Textarea
                ...
                value={formData.coreAssessment}
                onChange={(e) => setFormData({ ...formData, coreAssessment: e.target.value })}
                data-testid="textarea-core-assessment"
              />
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                value={formData.applicationAssessment}
                onChange={(e) => setFormData({ ...formData, applicationAssessment: e.target.value })}
                data-testid="textarea-application-assessment"
              />
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                value={formData.antiOverloadMeasures}
                onChange={(e) => setFormData({ ...formData, antiOverloadMeasures: e.target.value })}
                data-testid="textarea-anti-overload"
              />
            </div>
          </div>
        );
