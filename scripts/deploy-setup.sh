...
echo "   - Repository name: Pivot-N-Launch-PBL-Pedagogy-Tool"
...
echo -e "${GREEN}   git remote add origin https://github.com/[YOUR-USERNAME]/Pivot-N-Launch-PBL-Pedagogy-Tool.git${NC}"
...
echo "   - Super Admin: dtreku@wpi.edu"
echo "   - Admin: kwobbe@wpi.edu"
echo "   - Admin: kalechasseur@wpi.edu"
echo ""
